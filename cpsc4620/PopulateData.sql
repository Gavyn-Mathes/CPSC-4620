...
-- ORDER 3 -------------------------------------------------------
INSERT INTO customer(CustomerLName, CustomerFName, CustomerPhone)
...
-- Order 4
INSERT INTO customer(CustomerLName, CustomerFName, CustomerPhone, CustomerDeliveryStreet, CustomerDeliveryCity, CustomerDeliveryState, CustomerDeliveryZIP)
VALUES ('Wilkes-Krier', 'Andrew', '864-254-5861', '115 Party Blvd', 'Anderson', 'SC', '29621');
...
-- --------Order 5 ------------
INSERT INTO customer(CustomerLName, CustomerFName, CustomerPhone)
VALUES ('Enger', 'Matt', '864-474-9953');
...
WHERE d.DiscountName = 'Specialty Pizza';
 ...
 -- -- Order 6 -----------
INSERT INTO customer(CustomerLName, CustomerFName, CustomerPhone, CustomerDeliveryStreet, CustomerDeliveryCity, CustomerDeliveryState, CustomerDeliveryZIP)
VALUES ('Turner', 'Frank', '864-232-8944', '6745 Wessex Street', 'Anderson', 'SC', '29621');
...
-- -- -- Order 7
INSERT INTO customer(CustomerLName, CustomerFName, CustomerPhone, CustomerDeliveryStreet, CustomerDeliveryCity, CustomerDeliveryState, CustomerDeliveryZIP)
VALUES ('Auckermann', 'Milo', '864-878-5679', '8879 Suburban Home', 'Anderson', 'SC', '29621');
